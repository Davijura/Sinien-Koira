...
export default function AboutInfoSecond() {
    return (
        <div className="grid grid-cols-1 mx-auto md:grid-cols-2 gap-20 pb-28 items-center justify-items-center px-4 md:px-0 max-w-max">
            ...
            <div className="md:order-2 w-[450px]">
                <p className='font-bold text-black text-2xl pb-5'><strong>Nabízíme komplexní služby v oblasti lesnictví, včetně těžby dřeva, jeho zpracování a prodeje. </strong></p>
            ...
            <div className="md:order-1 w-[500px] h-[370px]">
