    ...
    return (
        <div className="grid grid-cols-1 mx-auto md:grid-cols-2 gap-20 pb-28 items-center justify-items-center px-4 md:px-0 max-w-max">
            ...
            <div className="md:order-2 max-w-[450px]">
                <p className='font-bold text-black text-2xl pb-5 text-center sm:text-left '><strong>Nabízíme komplexní služby v oblasti lesnictví, včetně těžby dřeva a prodeje palivového dřeva.</strong></p>
            ...
            <div className="md:order-1 w-[500px] h-[370px] sm:w-[500px] sm:h-[370px]">
                <img className="w-full h-full object-cover rounded-xl" src="/work.jpg" alt="Logo" />
            </div>
